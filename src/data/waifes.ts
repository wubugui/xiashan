...
const CONFIGS: WaifeConfig[] = [suli as WaifeConfig, aruo as WaifeConfig, sangluo as WaifeConfig, aman as WaifeConfig, shenzhaoning as WaifeConfig, murongxue as WaifeConfig, yunzhiyi as WaifeConfig];
